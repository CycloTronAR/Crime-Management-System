...
<body style="color: black;background-image: url(officer.jpg);background-size: 100%;background-repeat: no-repeat;">
  ...
  <div id="navbar" class="collapse navbar-collapse">
    <ul class="nav navbar-nav">
      <li><a href="official_login.php">Official Login</a></li>
        <li class="active"><a href="policelogin.php">Officer Login</a></li>
      </ul>
   </div>
  </div>
</nav>
<div  align="center" >
	<div class="form" style="margin-top: 15%">
      ...
      <div class="form-group" style="width: 30%">
        <label for="exampleInputEmail1"  ><h1 style="color:white">Officer Id</h1></label>
