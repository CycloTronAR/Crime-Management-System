...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
        ...
        <h2>Welcome</h2>
        <h5 align="center" style="color: #31c4fc">To register a complain first Register yourself with correct details</h5><br>
          ...
          <p style="color:#dfdfdf">Password</p><input type="text"  name="password"  placeholder="6 Characters minimum" pattern=".{6,}" id="pass" onfocusout="f1()"/>
					<p style="color:#dfdfdf">Home Address</p><input type="text"  name="adress"  required="" id="addr" onfocusout="f1()"/>
					<p style="color:#dfdfdf">Aadhaar Number</p><input type="text"  name="aadhar_number" minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="aadh" onfocusout="f1()"/>
