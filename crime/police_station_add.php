...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
      ...
      <form  method="post" style="color: gray">Police Station Location
        ...
        Incharge Name<input type="text"  name="incharge_name" placeholder="Incharge Name" required="" id="iname" onfocusout="f1()"/>
				Incharge Id<input type="text"  name="incharge_id" placeholder="Incharge Id" required="" id="iid" onfocusout="f1()"/><br>
