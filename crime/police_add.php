...
<head>
	...
	<link href="page_design.css" rel="stylesheet" type="text/css" media="all" />
	<?php
    session_start();
    if(!isset($_SESSION['x']))
...
<body style="background-size: cover;background-image: url(p_add.jpg);background-position: center;">
	...
	<div class="center-container">
		<div class="bg-agile">
			<div class="login-form"><p><h2>Log Police Officer</h2></p>	
				<form action="#" method="post" style="color: gray">Officer Name
					<input type="text"  name="police_name" placeholder="Name" required="" id="pname" onfocusout="f1()"/>
					Officer Id<input type="text"  name="police_id" placeholder="ID" required="" id="pid" onfocusout="f1()"/>
          Specialist<input type="text"  name="police_spec" placeholder="Specialisation" id="pspec" required onfocusout="f1()"/>
